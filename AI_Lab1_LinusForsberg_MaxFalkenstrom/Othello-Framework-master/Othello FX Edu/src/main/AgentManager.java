...
import static com.eudycontreras.othello.enumerations.PlayerTurn.PLAYER_ONE;
import static com.eudycontreras.othello.enumerations.PlayerTurn.PLAYER_TWO;
...
public class AgentManager extends Application{
	...
	public void start(Stage primaryStage) {
		new Othello(primaryStage, new ABAgent("Agent A", PLAYER_ONE), new ExampleAgentA(PLAYER_TWO));
